package com.ardy.stargazing.utils
...
fun storeImage(image: Bitmap, photoFile: File): Uri {
    try {
        ...
        Log.d(MainActivity.TAG, "File not found: " + e.message)
    } catch (e: IOException) {
        Log.d(MainActivity.TAG, "Error accessing file: " + e.message)
    }
...
fun rotateBitmap(src: String, bitmap: Bitmap): Bitmap {
    try {
        ...
        Log.d(MainActivity.TAG, "orientasi $orientation")
        return try {
